...
class JElementAKMenuItems extends JElement
{
	/**
	* Element name
	*
	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		return JHTML::_('select.genericlist',  $options, ''.$control_name.'['.$name.']'.$multipleArray, $attributes, 'value', 'text', $value, $control_name.$name);
